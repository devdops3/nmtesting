...
/// <summary>
/// Summary description for ShweStreamManager
/// </summary>
public class ShweStreamManager : IeService
{
    ...
    public string Confirm(ConfirmResponseModel confirmResponseModel, ResponseInfo responseInfo)
    {
        ...
        Utils.WriteLog_Biller("This is " + confirmResponseModel.billername + " biller Confirm : messageId :" + messageId);
